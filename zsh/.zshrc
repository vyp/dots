...
alias f='file'
# TODO: `find . -iname '*<filename>*'` function.
alias fd='find'
alias fnd='find . -name'
alias g='git'
alias ga='git add'
...
alias j='jobs'
alias l='less -R'
alias l1='ls -1p --color=always'
alias la='ls -Ap --color=always'
alias la1='ls -A1p --color=always'
alias lah='ls -lAh --color=always'
alias latr='ls -lAtr --color=always'
alias lh='ls -lh --color=always'
alias ll='less -RN'
alias ln='ln -v'
alias ls='ls -p --color=always'
alias ltr='ls -trp --color=always'
alias md='mkdir -pv'
alias mi='mediainfo'
...
alias se='sudoedit'
alias sm='ls ~/music | grep -i --color=always'
alias t='tail'
